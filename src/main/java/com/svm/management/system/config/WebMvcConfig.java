...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = { "com.svm.management.loginsystem.controller" })
public class WebMvcConfig extends WebMvcConfigurerAdapter {
     ...
     * bean = new InternalResourceViewResolver(); bean.setPrefix("/WEB-INF/views/");
     ...
     */
    /*
     * @Bean(name = "multipartResolver") public CommonsMultipartResolver getMultipartResolver() {
